    ...
    try {
      ...
      if (result.status === 'success' && result.data) {
        ...
        const transformedData = result.data.map((item, index) => ({
          ...
          status: item.JobStatus || item.status || 'pending', // Default to pending
          trainer: item.Trainer || item.trainer || '',
          assignedTo: item.AssignedTo || item.assignedTo || 'unassigned',
          remarks: item.Remarks || item.remarks || '', // Add remarks field for Admin too
        }));
    ...
    return [
      {
        ...
        trainer: '',
        assignedTo: 'TM001',
        remarks: 'Initial contact made. Waiting for response.',
      },
      {
        id: 2,
        ...
        trainer: '',
        assignedTo: 'TM002',
        remarks: 'Confirmed and payment is being processed.',
      },
      {
        id: 3,
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-4 mb-8">
          ...
          // ... (previous code for AdminDashboard.jsx)
                  ...
                  <tr key={submission.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-3 py-3 whitespace-nowrap">
                      <select
                        ...
                        onChange={(e) => updateSubmissionField(submission.id, 'assignedTo', e.target.value)}
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-lg max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            <div className="sticky top-0 bg-white border-b px-6 py-4 flex justify-between items-center">
              <h3 className="text-xl font-bold text-gray-900">Submission Details (Admin View)</h3>
              <button
                ...
                <div className="bg-gray-50 rounded-lg p-4 space-y-2">
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="col-span-2">
                        ...
                        {/* Admin can view remarks, but editing functionality is primarily for Sales */}
                        <p className="font-medium whitespace-pre-wrap">{selectedSubmission.remarks || 'No remarks added.'}</p>
                    </div>
                  </div>
                </div>
              </div>
